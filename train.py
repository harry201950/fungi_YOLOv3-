...
MODEL_NAME         = "fungi_custom"    # 저장될 모델의 이름
SCORE_THRESHOLD    = 0.3
...
trainset = DataGenerator(data_path="/xml", annot_path="fungi_train.txt", class_label_path="fungi.names")
testset = DataGenerator(data_path="/xml_test", annot_path="fungi_test.txt", class_label_path="fungi.names")
